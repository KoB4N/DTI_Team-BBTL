...
#define ESP_UUID {0xD2, 0x13, 0x3C, 0xF6, 0x15, 0x7C, 0x44, 0x5B, 0x93, 0x07, 0x94, 0x74, 0xE8, 0x3E, 0x44, 0xFB}

#define ESP_MAJOR   10167
#define ESP_MINOR   61958

/* Add local name to the advertisement data structure */
#define ESP_BLE_AD_TYPE_NAME_COMPLETE 0x09

/* Define local name for iBeacon device */
#define LOCAL_NAME "MyiBeacon_1"
